...
def find_root_solver(input_function_and_derivatives, func_str, parameter_ranges_of_input_func, variable_range, nr_of_derivatives=1):
	...
	(cgp_start_guess, error_start_guess, parameters_start_guess) = starting_point_approximation(input_function_and_derivatives[0], nr_of_parameters_of_input_func, parameter_ranges_of_input_func, max_time=60*60*1)
	start_guess = lambda x: cgp_start_guess.eval(x, parameters=parameters_start_guess)
	(cgp_iterative, error_iterative, parameters_iterative) = direct_iterative_function_finder(start_guess, input_function_and_derivatives, nr_of_parameters_of_input_func, parameter_ranges_of_input_func, variable_range, nr_of_derivatives=nr_of_derivatives, max_iter=1000, nr_of_samples_per_inp_parameter=15, nr_of_cgp_pars=2, max_time=60*60*4)
